...
namespace ROWM
{
    public class StartupAtcQ43Release1
    {
        public StartupAtcQ43Release1(IConfiguration configuration)
        {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IFeatureUpdate, AtcParcel>(fac =>
                new AtcParcel("https://maps2.hdrgateway.com/arcgis/rest/services/Wisconsin/ATC_Q43_Parcel_FS/FeatureServer"));
            services.AddSingleton<IRenderer>(new AtcParcel("https://maps2.hdrgateway.com/arcgis/rest/services//Wisconsin/ATC_Q43_ROW_Mapservice/MapServer"));
            services.AddSingleton<IMapSymbology, AtcQ43Symbology>();

            var sec = AtcSharePointConfig.SharePointAppSecret();
            services.AddScoped<ISharePointCRUD, SharePointCRUD>(fac =>
                new SharePointCRUD(sec.AppId, sec.AppSec, "https://atcpmp.sharepoint.com/atcrow/q43",
                d: fac.GetRequiredService<DocTypes>()));

            services.AddSingleton<SiteDecoration, AtcQ43>();
