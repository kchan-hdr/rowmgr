...
namespace ROWM
{
    public class StartupAtcQ43
    {
        public StartupAtcQ43(IConfiguration configuration)
        {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IFeatureUpdate, AtcParcel>(fac =>
                new AtcParcel("https://maps2-stg.hdrgateway.com/arcgis/rest/services/Wisconsin/ATC_Q43_Parcel_FS/FeatureServer"));
            services.AddSingleton<IRenderer>(new AtcParcel("https://maps2-stg.hdrgateway.com/arcgis/rest/services//Wisconsin/ATC_Q43_ROW_Mapservice/MapServer"));
